...
- the reference-focused set now uses direct `10gs`-derived analogs, so ref coverage reflects scaffold retention instead of switching to unrelated molecules
