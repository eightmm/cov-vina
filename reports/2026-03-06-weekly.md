...
![Low coverage acetanilide](../examples/10gs/visualizations/coverage/low_acetanilide_100steps.gif)

Medium coverage:

![Medium coverage aspirin](../examples/10gs/visualizations/coverage/medium_aspirin_100steps.gif)

High coverage:

![High coverage ibuprofen](../examples/10gs/visualizations/coverage/high_ibuprofen_100steps.gif)
